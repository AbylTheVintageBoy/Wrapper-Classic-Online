...
(function(){var f=null;function k(a){this.t={};this.tick=function(a,c,d){d=d?d:(new Date).getTime();this.t[a]=[d,c]};this.tick("start",f,a)}var l=new k;window.GA_jstiming={Timer:k,load:l};if(window.GA_jstiming){window.GA_jstiming.d={};window.GA_jstiming.i=1;var m=function(a,b,c){var d=a.t[b],e=a.t.start;if(d&&(e||c))return d=a.t[b][0],e=c!=void 0?c:e[0],d-e};window.GA_jstiming.report=function(a,b,c){var d="";a.h&&(d+="&"+a.h);var e=a.t,h=e.start,j=[],o=[],g;for(g in e)if(g!="start"&&g.indexOf("_")!=0){var p=e[g][1];p?e[p]&&o.push(g+"."+m(a,g,e[p][0])):h&&j.push(g+"."+m(a,g))}delete e.start;if(b)for(var s in b)d+="&"+s+"="+b[s];var a=[c?c:"https://web.archive.org/web/20110601191945/http://csi.gstatic.com/csi","?v=3","&s="+(window.GA_jstiming.sn||
...
/*
     FILE ARCHIVED ON 19:19:45 Jun 01, 2011 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 03:48:25 Mar 24, 2023.
...
playback timings (ms):
  ...
  cdx.remote: 0.086
  esindex: 0.008
  LoadShardBlock: 111.965 (6)
  PetaboxLoader3.datanode: 140.896 (7)
  load_resource: 106.103
  PetaboxLoader3.resolve: 54.398
*/